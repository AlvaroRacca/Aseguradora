...
function CelularCotizacionRapida() {
  ...
  return (
    <div className="App">
      <h1 className="datos-personales-h1">Datos para cotizar Celular</h1>
      <form className="formulario-personal">
        ...
        <InputGlobal titulo="Año" type="number" name="Año"
          ...
          onChange={handleInputChange} required placeholder=""></InputGlobal>
        <InputGlobal titulo="Memoria (Gigabyte)" name="Memoria" type="number"
...
export default CelularCotizacionRapida;